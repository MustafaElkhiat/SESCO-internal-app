...
export default function TripList({ tripList }) {
  ...
  const handleSpaces = (order, index) => {
    ...
    // @ts-ignore
    return Array(numberOfSpaces)
      .fill()
      .map((obj) => <div className="min-w-[300px]"></div>);
  };

  return (
    <div className="bg-white p-5 mx-4 mt-4 rounded-2xl shadow-lg overflow-x-auto">
                  ...
                  <div className="px-1">
                    ...
                    <CheckPoint
                      ...
                      time={checkPoint.time}
                        ...
                        index < trip.tripCheckPointList.length - 1 ||
                        !trip.isOpened
                      }
