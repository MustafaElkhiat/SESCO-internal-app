...
export default function BookingPattern({ booking }) {
  ...
  return (
    ...
    className=" md:px-12 mt-4">
      ...
      {pattern  && <button onClick={addPatternToBooking}
      className="py-2 px-4 mb-2 rounded-lg shadow-xl flex items-center justify-center mx-auto bg-sky-700 text-white hover:bg-sky-400 transition-all "
      >Add Pattern</button>}
    </motion.div>
  );
}
