...
import { Truck, TruckIcon, PersonStanding, UserCheck2 } from "lucide-react";
...
const ContractorPage = ({ params }) => {
  ...
  const handleReturnTruckFromMaintenance = async (truck) => {
    const result = await PUTAPI(
      `/api/contractor/${contractor.code}/returnFromMaintenance`,
      truck
    );
    setContractor(result);
  };
    ...
    return (
      <div>
        ...
        <motion.div
          ...
          className="px-4 md:px-12 lg:px-1 space-y-4  grid  gap-4"
        >
          <Card className="p-4  border-black/5 flex flex-col mt-4 shadow-md hover:shadow-xl transition rounded-2xl ">
            <div className="  flex items-center justify-center   ">
              ...
              <div className="flex justify-between shadow-md p-2">
                ...
                <div className="flex justify-between gap-8  p-2  shadow-md  ">
                  ...
                  <div className="text-md flex justify-center items-center">
                    <PersonStanding  className=" text-sky-500" />
                    <span className="font-bold">
