...
export default function CargoPage() {
  ...
  return (
    <div className="">
      ...
      <div className="px-4 md:px-12 flex flex-col md:flex-row mt-8 justify-start items-center ">
        <div className="flex-1 mb-4 ">
          <NewCargo
            ...
            onCargoCreated={handleAPIAddCargo}
          />
        </div>
      ...
      <div className=" px-4 md:px-12 space-y-4 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
